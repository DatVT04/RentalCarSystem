...
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (1, N'Xe Sedan', N'Xe sedan ph? thông và cao c?p', NULL, 1, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (2, N'Xe SUV', N'Xe SUV và ??a hình', NULL, 1, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (3, N'Xe Van/MPV', N'Xe ?a d?ng và gia ?ình', NULL, 1, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (4, N'Xe Sang', N'Xe h?ng sang và cao c?p', NULL, 1, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (5, N'Xe ??c Bi?t', N'Xe th? thao, c? ?i?n và ??c bi?t', NULL, 1, N'active')
GO
...
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (7, N'Sedan 5 ch?', N'Xe sedan tiêu chu?n 5 ch? ng?i', 1, 2, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (8, N'SUV 5 ch?', N'Xe SUV c? nh? và trung 5 ch?', 2, 2, N'active')
GO
...
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (12, N'Toyota Vios', N'Xe Toyota Vios các ??i', 7, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (13, N'Honda City', N'Xe Honda City các ??i', 7, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (14, N'Hyundai Accent', N'Xe Hyundai Accent các ??i', 7, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (15, N'Mazda 3', N'Xe Mazda 3 các ??i', 7, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (16, N'Kia Cerato', N'Xe Kia Cerato các ??i', 7, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (17, N'Honda Civic', N'Xe Honda Civic các ??i', 7, 3, N'active')
GO

-- Level 3: Chi ti?t SUV 5 ch? (6 categories)
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (18, N'Honda CR-V', N'Xe Honda CR-V các ??i', 8, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (19, N'Mazda CX-5', N'Xe Mazda CX-5 các ??i', 8, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (20, N'Ford EcoSport', N'Xe Ford EcoSport các ??i', 8, 3, N'active')
GO
...
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (24, N'Toyota Fortuner', N'Xe Toyota Fortuner các ??i', 9, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (25, N'Ford Everest', N'Xe Ford Everest các ??i', 9, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (26, N'Mazda CX-8', N'Xe Mazda CX-8 các ??i', 9, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (27, N'Hyundai SantaFe', N'Xe Hyundai SantaFe các ??i', 9, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (28, N'Mitsubishi Xpander', N'Xe Mitsubishi Xpander các ??i', 9, 3, N'active')
GO

-- Level 3: Chi ti?t Van 7 ch? (4 categories)
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (29, N'Toyota Innova', N'Xe Toyota Innova các ??i', 10, 3, N'active')
GO
...
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (31, N'Suzuki Ertiga', N'Xe Suzuki Ertiga các ??i', 10, 3, N'active')
GO
...
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (40, N'Xe Th? Thao', N'Xe th? thao và coupe', 5, 2, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (41, N'Xe Bán T?i', N'Xe bán t?i pickup', 5, 2, N'active')
GO
...
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (64, N'Ford Ranger', N'Xe Ford Ranger bán t?i', 41, 3, N'active')
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (65, N'Toyota Hilux', N'Xe Toyota Hilux bán t?i', 41, 3, N'active')
GO
...
GO
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (67, N'Mazda BT-50', N'Xe Mazda BT-50 bán t?i', 41, 3, N'active')
GO

-- Thêm các categories b? sung ?? ?? 71 (4 categories)
INSERT [dbo].[categories] ([id], [name], [description], [parent_id], [level], [status]) VALUES (68, N'Xe ?i?n', N'Xe ?i?n các lo?i', 5, 2, N'active')
GO

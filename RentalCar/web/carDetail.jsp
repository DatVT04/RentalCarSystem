...
<html>
    <head>
        <title>${car.title} - Rental Car</title>
            ...
            <div class="car-container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-section">
                            <div class="thumbnail-container">
                                <c:choose>
                                    <c:when test="${not empty car.subImages}">
                                        <c:forEach items="${car.subImages}" var="image" varStatus="status">
                                            <img src="${image}" class="thumbnail ${status.index == 0 ? 'active' : ''}" 
                                                 alt="${car.title} - Image ${status.index + 1}"
                            ...
                            <img src="${car.thumbnail}" class="car-image-main" id="main-car-image" alt="${car.title}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="options-row align-items-end">
                                <div class="options-col">
                                    ...
                                    <div class="quantity-selector">
                                        ...
                                        <input type="number" id="quantity" name="quantity" class="form-control quantity-input" value="1" min="1" max="${car.stock}">
                        ...
                        <div class="car-meta">
                            <div class="meta-item">
                                <strong>Danh Mục:</strong> <a href="listcar?category=${car.categoryId}">${categoryName}</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <div class="filter-buttons">
                                    <a class="btn btn-outline-secondary me-2" href="cardetail?id=${car.id}#feedback_section">Tất Cả</a>
                                    <a class="btn btn-outline-secondary me-2" href="cardetail?id=${car.id}&filterStar=5#feedback_section" onclick="${fiveStarCount > 0 ? 'return true;' : 'return false;'}">5 Sao (${fiveStarCount})</a>
                                    <a class="btn btn-outline-secondary me-2" href="cardetail?id=${car.id}&filterStar=4#feedback_section" onclick="${fourStarCount > 0 ? 'return true;' : 'return false;'}">4 Sao (${fourStarCount})</a>
                                    <a class="btn btn-outline-secondary me-2" href="cardetail?id=${car.id}&filterStar=3#feedback_section" onclick="${threeStarCount > 0 ? 'return true;' : 'return false;'}">3 Sao (${threeStarCount})</a>
                                    <a class="btn btn-outline-secondary me-2" href="cardetail?id=${car.id}&filterStar=2#feedback_section" onclick="${twoStarCount > 0 ? 'return true;' : 'return false;'}">2 Sao (${twoStarCount})</a>
                                    <a class="btn btn-outline-secondary me-2" href="cardetail?id=${car.id}&filterStar=1#feedback_section" onclick="${oneStarCount > 0 ? 'return true;' : 'return false;'}">1 Sao (${oneStarCount})</a>
                                </div>
                            </div>
                        </div>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <c:if test="${currentPage > 1}">
                            <li class="page-item">
                                <a class="page-link" href="cardetail?id=${car.id}&filterStar=${filterStar}&page=${currentPage - 1}#feedback_section" aria-label="Previous">
                        ...
                        <c:forEach begin="1" end="${totalPages}" var="i">
                            <li class="page-item ${i == currentPage ? 'active' : ''}">
                                <a class="page-link" href="cardetail?id=${car.id}&filterStar=${filterStar}&page=${i}#feedback_section">${i}</a>
                            </li>
                        </c:forEach>
                        <!-- Nút Next -->
                        <c:if test="${currentPage < totalPages}">
                            <li class="page-item">
                                <a class="page-link" href="cardetail?id=${car.id}&filterStar=${filterStar}&page=${currentPage + 1}#feedback_section" aria-label="Next">
                    ...
                    <c:forEach items="${similarCars}" var="similarCar" varStatus="status">
                        <c:if test="${status.index < 4}">
                            <div class="card car-card">
                                <a href="cardetail?id=${similarCar.id}" style="text-decoration:none;">
                                    <div class="position-relative">
                                        <img src="${similarCar.thumbnail}" class="car-image" alt="${similarCar.title}">
                                    </div>
                                    <div class="car-info">

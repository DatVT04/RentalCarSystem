...
<html>
            ...
            <div class="main-content">
                ...
                <div class="chat-box" id="chatBox">
                    <c:forEach items="${messages}" var="msg">
                        <div class="message ${msg.senderId == ownerId ? 'message-sent' : 'message-received'}">
    ...
    function initWebSocket() {
        ...
        ws.onmessage = function (event) {
            ...
            messageDiv.className = "message " + (data.senderId === ownerId ? "message-sent" : "message-received");
    ...
    fetch('/RentalCar/proxy/emoji')
        ...
        .then(data => {
            ...
            data.slice(0, 301).forEach(emoji => {
                var span = document.createElement("span");
                span.textContent = emoji.char; // Sử dụng trường "char" thay vì "character"
                span.style.cursor = "pointer";
                span.style.fontSize = "24px";
                span.style.margin = "5px";
                span.onclick = function() {
                    var input = document.getElementById("messageInput");
                    input.value += emoji.char; // Thêm emoji vào input
                };

 ...
 * @author nguye
 */
@WebServlet(name = "FeedbackListServlet", urlPatterns = {"/owner/feedbacklist"})
public class FeedbackListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/owner/feedback/feedbackList.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("updateStatus".equals(action)) {
            try {
                ...
                if (updated) {
                    response.sendRedirect(request.getContextPath() + "/owner/feedbacklist?success=update");
                } else {
            ...
            try {
                ...
                if (deleted) {
                    response.sendRedirect(request.getContextPath() + "/owner/feedbacklist?success=delete_feedback");
                } else {
                    response.sendRedirect(request.getContextPath() + "/owner/feedbacklist?error=delete_feedback");
                }
            } catch (Exception e) {
                e.printStackTrace();
                response.sendRedirect(request.getContextPath() + "/owner/feedbacklist?error=delete_feedback");

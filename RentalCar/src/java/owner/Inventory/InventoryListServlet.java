 ...
 * @author nguye
 */
@WebServlet(name = "InventoryListServlet", urlPatterns = {"/owner/inventorylist"})
public class InventoryListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/owner/inventory/listInventory.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
